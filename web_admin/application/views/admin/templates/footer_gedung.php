...
<script src="<?php base_url()?>assets/js/datatables.min.js"></script> -->
  <script type="text/javascript">
    ...
    $('#ruangan').DataTable({
    	...
    	"ajax":{
    		url : "<?php echo site_url('Home/data_server_gedung') ?>",
    		type : "POST"
    	},
    	"columnDefs":
    	[
    		...
    		},
    		{
                ...
                "render":function(data,type,full,meta){
                    return '<img src="../../../RestApi/application/upload_gedung/'+data+'" width="75px" height="75px">';
                }
            },
    		{
    			"targets":3,
    			...
    			"searchable":false,
    			"render":function(data,type,full,meta){
    				return '<a href="<?=site_url()?>/Home/update_gedung/'+data["kd_gedung"]+'">Edit</a>'
    			}
    		},
    		{
    			"targets":4,
    			...
    			"searchable":false,
    			"render":function(data,type,full,meta){
    				return '<a href="<?=site_url()?>/Home/delete_gedung/'+data["kd_gedung"]+'">Delete</a>'
    			}
    		}
    	]
